...
<div class="container-fluid">
    <div class="row clear-paddings">
        <div class="col-md-12" style="padding: 0;">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel" style="background-color: #CCC;height: 500px;">
              <!-- Indicators -->
              <ol class="carousel-indicators">
				...
				<div class="item">
				  ...
				  <div class="override-carousel-caption">
					<div  style="float: left;width:45%;text-align: right;padding-top: 30px;padding-right: 30px;">
						<img src="<?=PUBLIC_URL?>images/stock/recent-activities/archive_iitm.png" alt="" />
					</div>
					<div style="float: right;width:55%;padding-top: 30px;padding-right: 20px;text-align: center;margin: 80px auto;">
